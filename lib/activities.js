...
export function classifyDaySmartActivity({ company, leagueName, eventText }) {
...
export function daySmartDropInDetails(company, leagueName) {
  ...
  return {
    ...
    'kraken:Novice Drop-In': {
      subtitle: 'Beginner · Division 6 or lower',
      eligibility: eligibility({ skill: 'Beginner; Division 6 or lower' }),
    },
    "snoking:MH's Chill Drop-In": {
      subtitle: 'Adult coed · All skill levels',
      eligibility: eligibility({ audience: 'adult', skill: 'All skill levels' }),
    },
    ...
    "snoking:Women's Drop-In": {
      ...
      eligibility: eligibility({ audience: 'women', skill: 'All skill levels' }),
    },
    'snoking:Adult Weekend Drop-In': {
      subtitle: 'Adult',
      eligibility: eligibility({ audience: 'adult' }),
    },
    'snoking:SKAHL Beginner Drop-In': {
      subtitle: 'Beginner',
      eligibility: eligibility({ skill: 'Beginner' }),
    },
    'snoking:Adult Learn to Play 3v3 Drop-In': {
      subtitle: 'Adult · New and beginning players · 3v3',
      eligibility: eligibility({
        audience: 'adult',
