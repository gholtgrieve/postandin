...
export async function scrapeDaySmart(
  ...
  const [data, rdata] = await Promise.all([
    dsGet(`https://apps.daysmartrecreation.com/dash/jsonapi/api/v1/events?filter[homeTeam.sport_id__in]=${sportId}&company=${company}&filter[start__gte]=${today}&page[size]=200&include=homeTeam`),
