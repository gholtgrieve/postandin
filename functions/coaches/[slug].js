...
.lessons-heading { font-family: 'Bebas Neue', sans-serif; font-size: 18px; letter-spacing: 0.08em; color: #D4A800; margin-bottom: 6px; }
  ...
  if (apiKey && baseId) {
    try {
      const record = await readThrough(
        ...
        // status to be read when Live profiles become indexable. Must stay
